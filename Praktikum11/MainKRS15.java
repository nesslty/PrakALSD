        ...
        do {
            ...
            switch (pilih) {
                case 1:
                    ...
                    MahasiswaNew15 m = new MahasiswaNew15(nim, nama, prodi, kelas);
                    antrian.enqueue(m);
                    break;
                case 2:
                    antrian.dequeue();
                ...
                case 5:
                    ...
                    break;
                case 6:
                    System.out.println("Jumlah antrian saat ini: " + antrian.jumlah());
                    break;
                case 7:
                    System.out.println("Jumlah yang sudah melakukan proses KRS: " + antrian.jumlahProses());
                    break;
                case 8:
                    System.out.println("Mahasiswa yang belum KRS: " + antrian.sisa());
                    break;
                case 9:
                    antrian.clear();
